...
public class OdometrySim implements OdometryIO {

    private final SwerveDriveOdometry odometry;
    
    public OdometrySim(SwerveDriveKinematics kinematics, Rotation2d heading, SwerveModulePosition[] swerveModulePositions) {
